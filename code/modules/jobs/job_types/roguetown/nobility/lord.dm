...
/datum/job/roguetown/lord/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	...
	if(L)
		...
		if(L.gender != FEMALE)
			to_chat(world, "<b><span class='notice'><span class='big'>[L.real_name] is King of Zybantis.</span></span></b>")
//			addtimer(CALLBACK(L, TYPE_PROC_REF(/mob, lord_color_choice)), 50)
		else
			to_chat(world, "<b><span class='notice'><span class='big'>[L.real_name] is Queen of Zybantis.</span></span></b>")
//			addtimer(CALLBACK(L, TYPE_PROC_REF(/mob, lord_color_choice)), 50)
